...
$arrLink['Settings']= array(
							  'workgroup' 	  => array('Work Group', 'index.php?model=workgroup', 'icon icon-darkgray icon-users'),
							  'users' => array('Users', 'index.php?model=users', 'icon-user')								
					 		);
