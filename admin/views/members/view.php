      ...
      <div class="box-content">
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="control-group">
              <label class="control-label" for="zipcode"><?=$lang['Zipcode']?></label>
              <div class="controls"><span class="input-xlarge uneditable-input">
                <?=$row->zipcode?>
                </span></div>
            </div>
            ...
            <div class="control-group">
              ...
              <span class="input-xlarge uneditable-input" style="width:120px;"> <strong>$</strong><?=$arrIncome[0]?></span>
                &nbsp;to&nbsp;
                 <span class="input-xlarge uneditable-input" style="width:120px;"><strong>$</strong><?=$arrIncome[1]?></span>
              </div>
            </div>
