...
<div>
  <ul class="breadcrumb">
    ...
    <li><a href="#"><?=$lang['Edit Member']?></a></li>
  </ul>
</div>
        ...
        <input type="hidden" name="pk_id" id="pk_id" value="<?=$_REQUEST['id']?>" />
          <fieldset>
            <div class="control-group">
              ...
              <div class="controls"> 
               <input type="number" required value="<?=$row->membership_id?>" id="data_membership_id" name="data_membership_id" class="input-xsmall focused" data-validation-number-message="Membership number should be numeric"></div>
            </div>
             <div class="control-group">
            ...
            <div class="control-group">
              <label class="control-label" for="data_lname"><?=$lang['Last Name']?></label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label" for="name"><?=$lang['State']?></label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label" for="name"><?=$lang['Country']?></label>
              <div class="controls">
                <input type="text" required value="<?=$row->country?>" id="data_country" name="data_country" class="input-xsmall focused">
              </div>
            </div>
             <div class="control-group">
              <label class="control-label" for="data_country"><?=$lang['Zipcode']?></label>
              <div class="controls">
            ...
            <div class="control-group">
              ...
              <div class="input-prepend input-append" style="margin-left:21px;">
                <span class="add-on">$</span><input type="number" value="<?=$arrIncome[0]?>" id="txt_income_from" name="txt_income_from" class="input-xsmall focused" style="width:80px;">
                &nbsp;to&nbsp;
                <span class="add-on">$</span><input type="number" value="<?=$arrIncome[1]?>" id="txt_income_to" name="txt_income_to" class="input-xsmall focused" style="width:80px;">
            ...
            <div class="control-group">
              ...
              <div class="input-prepend">
				 <span class="add-on"><i class="icon-envelope"></i></span>
                  <input required type="email" value="<?=$row->email_address?>" id="data_email_address" name="data_email_address" class="input-xsmall focused" data-validation-email-message="Please enter valid Email Address"></div>
              </div>
            </div>
