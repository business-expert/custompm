...
<head>
    ...
    <link href='<?=CSS_ADMIN?>bootstrap-formhelpers.css' rel='stylesheet'>
...
<!-- application script for select box -->
<script src="<?=JS_ADMIN?>bootstrap-formhelpers-selectbox.js"></script>
<!-- application script for treeview -->
			...
			<div class="container-fluid">
                ...
                <?php 
					...
					<div class="btn-group pull-right" >
					  <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i><span class="hidden-phone"> <?=$_SESSION['site']['pm_user'];?></span>
						<span class="caret"></span>
					  </a>
                      
					<ul class="dropdown-menu">
						<li><a href="index.php?model=profile"><?=$lang['Profile']?></a></li><li class="divider"></li>
                ...
                <?php } ?>
                 ...
                 <?php
					...
					$langs 	  = ($_SESSION['pm_session_lang'] != '') ? $_SESSION['pm_session_lang'] : 'dutch';
					
					foreach($arrQuery as $val)
					{
						$arrQ = explode("=",$val);
						
						if($arrQ[0] != 'lang' && $arrQ[0] != '')
                ...
                <div class="btn-group pull-right" >
                    ...
                    <ul id="lang" class="dropdown-menu">
                      ...
                      <li><a href="<?=$URL."dutch"?>" data-value="chines"><i class="icon-blank <?=$chn?>"></i> Dutch</a></li>
                    </ul>
				</div>
